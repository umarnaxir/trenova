...
import { getAddresses, addAddress, updateAddress, deleteAddress } from "@/services/address.service";
...
export default function AddressesPage() {
  ...
  const fetchAddresses = useCallback(async () => {
    try {
      ...
      pushToast("Failed to load addresses", "error");
    } finally {
      setLoading(false);
    }
  }, [pushToast]);
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      pushToast(err.message || "Failed to save address", "error");
    }
  }
  ...
  async function removeAddress(id: string) {
    ...
    try {
      ...
      pushToast(err.message || "Failed to remove address", "error");
    }
  }
