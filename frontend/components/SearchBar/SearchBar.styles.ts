...
export const QuickSuggestionsSection = styled.div`
  padding: 0.75rem 0.25rem 0.5rem;
`;

export const QuickSuggestionsLabel = styled.span`
  display: block;
  font-size: 0.75rem;
  font-weight: 700;
...
export const QuickChipsWrap = styled.div`
  display: flex;
  flex-wrap: wrap;
  gap: 0.5rem;
`;
...
export const QuickChip = styled.button<{ $active?: boolean }>`
  ...
  border: 1px solid
    ${({ $active, theme }) =>
      $active ? theme.colors.goldDark : theme.colors.gray300};
  background: ${({ $active, theme }) =>
    $active ? theme.colors.gray100 : theme.colors.white};
  color: ${({ $active, theme }) =>
    $active ? theme.colors.goldDark : theme.colors.black};
  cursor: pointer;
...
export const ResultBadgesWrap = styled.div`
  display: flex;
  align-items: center;
  gap: 0.35rem;
  margin-top: 0.15rem;
...
export const ResultBadge = styled.span<{ $variant?: "bestseller" | "featured" | "new" | "sale" }>`
  font-size: 0.65rem;
  font-weight: 700;
  text-transform: uppercase;
